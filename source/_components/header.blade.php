...
<div class="flex items-center justify-center text-center py-12 lg:py-20 px-6">
	<div x-in-view class="group flex flex-col gap-2">
		...
		@if($desc)
		<p class="mt-4 mb-0 block mx-auto max-w-[800px] group-hover:text-orange-500 dark:group-hover:text-white group-[&.in-view]:text-orange-500 group-[&.in-view]:dark:text-white">
			{!! $desc ?? $desc !!}
		</p>
		@endif
	</div>

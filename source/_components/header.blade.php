...
<div class="flex items-center justify-center text-center py-12 lg:py-20 px-4">
	<div x-in-view class="group flex flex-col gap-2">
		...
		<h2
			...
			class="m-0 group-hover:text-red-500 group-hover:font-extrabold group-[&.in-view]:text-red-500 group-[&.in-view]:font-extrabold block text-6xl lg:text-8xl leading-tightest mb-4 text-center font-bold max-w-[850px] max-w-[1050px] duration-150">
			{!! $h2 ?? $h2!!}
		</h2>
		@if($desc)

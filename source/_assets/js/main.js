...
Alpine.store('visitor', {
  firstVisitDate: Alpine.$persist(null).as('firstVisitDate'),
	...
	prefills: {
			...
			'home': 'I want to get to know more about Frendo...',
			'websites': 'A little bird told me you know a thing or two about websites...',
			'websites-new': 'I want to build a new website...',
			'websites-redesign': 'I want to update the look and feel of my website...',
			'websites-support': 'I need help with something that is not working on my website...',
			'websites-ongoing': 'I started a new site but I\'m stuck on this part...',
			'websites-updates': 'I need to make some changes to my website...',
			...
			'custom-web-apps-innovation': 'I have an idea for a new software product, but how would someone build something like this...',
			...
			'digital-consulting-admin': 'I need someone to take over managing my website...',
			'digital-consulting-audits': 'How do I make sure that my website is doing everything right...',
			'digital-consulting-novice': 'I am a little new to all this website stuff, what do I need to ask...',

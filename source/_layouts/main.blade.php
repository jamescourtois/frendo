...
<html lang="en">
    ...
    <body x-cloak x-data="{ navOpen: false }" class="bg-white text-gray-700 dark:bg-neutral-900 dark:text-not-white flex flex-col justify-between min-h-screen leading-normal font-sans">

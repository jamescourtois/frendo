<footer class="pt-8 bg-gray-200 dark:bg-neutral-800" role="contentinfo">
		...
		<ul class="flex flex-col font-normal justify-center items-center list-none text-xs text-center">
				...
				<li>
					<span class="inline-block text-xs leading-[1rem]">Forms secured by <a href="https://form-data.com">form-data.com</a>. All data is deleted after 90 days and never shared or sold.</span>
				</li>
		</ul>
</footer>
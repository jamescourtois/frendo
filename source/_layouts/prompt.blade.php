		...
		@foreach($answers as $a)
			<li class="flex lg:min-w-[48%] gap-4 items-center justify-center relative">
				<button
					...
					class="block whitespace-nowrap group-hover:bg-yellow-300 dark:group-hover:bg-black cursor-pointer border-2 border-not-black dark:border-not-white w-full px-4 py-2 relative bg-white dark:bg-black after:-mb-2 after:-ml-2 after:mt-2 after:mr-2 after:absolute after:inset-0 after:bg-not-black dark:after:bg-not-white hover:after:bg-black dark:hover:after:bg-white hover:text-black dark:hover:text-white hover:border-black dark:hover:border-white after:-z-10 hover:after:-mb-4 hover:after:-ml-4 after:duration-150 hover:after:mt-4 hover:after:mr-4 hover:font-bold text-lg lg:text-xl duration-150"

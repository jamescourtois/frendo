<div id="prompt" class="flex group flex-col px-4 py-8 lg:p-10 border-2 duration-150 text-center hover:bg-green-500 dark:hover:bg-black border-not-black dark:border-not-white mx-auto max-w-[1050px] relative after:-mb-2 after:-ml-2 after:mt-2 after:mr-2 after:absolute after:inset-0 after:border-l-[calc(var(--spacing)*2)] after:border-b-[calc(var(--spacing)*2)] after:border-not-black after:-z-10 dark:after:border-not-white hover:after:-mb-4 hover:after:-ml-4 after:duration-150 hover:after:mt-4 hover:after:mr-4 hover:after:border-l-[calc(var(--spacing)*4)] hover:after:border-b-[calc(var(--spacing)*4)]">
	<h2 class="text-center group-hover:text-black group-hover:dark:text-green-500 duration-150 mb-8 mx-auto font-semibold max-w-[850px] text-3xl lg:text-5xl">{!! $question !!}</h2>

...
<div class="m-0 flex flex-col mx-auto max-w-[800px] my-20 lg:my-24 gap-20 lg:gap-24 px-4">
	<div class="mx-auto group" id="community">
		...
		<div>
			...
			<a href="/contact" class="mt-auto btn-green px-4 py-2 rounded-full group-hover:border-blue-600 group-hover:text-blue-600 lg:text-2xl lg:px-8 lg:py-4">Let's lay the foundation</a>
		</div>
	</div>
	<div class="mx-auto group" id="productivity">
		...
		<div>
			...
			<a href="/contact" class="mt-auto btn-green px-4 py-2 rounded-full group-hover:border-blue-600 group-hover:text-blue-600 lg:text-2xl lg:px-8 lg:py-4">Let's talk metrics</a>
		</div>
	</div>
	<div class="mx-auto group" id="automation">
		...
		<div>
			...
			<a href="/contact" class="mt-auto btn-green px-4 py-2 rounded-full group-hover:border-blue-600 group-hover:text-blue-600 lg:text-2xl lg:px-8 lg:py-4">Let's document the patterns</a>
		</div>
	</div>
	<div class="mx-auto group" id="integration">
		...
		<div>
			...
			<a href="/contact" class="mt-auto btn-green px-4 py-2 rounded-full group-hover:border-blue-600 group-hover:text-blue-600 lg:text-2xl lg:px-8 lg:py-4">Let's start a diagram</a>
		</div>
	</div>
	<div class="mx-auto group" id="innovation">
		...
		<div>
			...
			<a href="/contact" class="mt-auto btn-green px-4 py-2 rounded-full group-hover:border-blue-600 group-hover:text-blue-600 lg:text-2xl lg:px-8 lg:py-4">Let's talk about your vision</a>
		</div>
	</div>
</div>

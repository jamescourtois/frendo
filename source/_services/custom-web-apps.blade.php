...
<x-content-blocks-wrapper>
		...
		<x-content-block id="innovation">
			...
			<x-slot name="content">
				<p>If you have an original idea for a software product, the first step is proving it works. Building the simplest version first turns your vision into something real enough to test, share, and grow. You provide the vision and let Frendo handle the infrastructure.</p>
			</x-slot>
			<x-slot name="button_text">
				Share your vision
			</x-slot>

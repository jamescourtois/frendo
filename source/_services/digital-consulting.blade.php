...
@section('body')
	...
	<div class="mx-auto group" id="rebuild">
		...
		<div>
			...
			<a href="/contact" class="btn-flashy group-hover:border-blue-600 group-hover:text-blue-600 dark:group-hover:border-white dark:group-hover:text-white px-4 py-2 rounded-full lg:text-2xl lg:px-8 lg:py-4">Start planning</a>
		</div>
	</div>
	<div class="mx-auto group" id="takeover">
		...
		<div>
			...
			<a href="/contact" class="btn-flashy group-hover:border-blue-600 group-hover:text-blue-600 dark:group-hover:border-white dark:group-hover:text-white px-4 py-2 rounded-full lg:text-2xl lg:px-8 lg:py-4">Let's look under the hood</a>
		</div>
	</div>
	<div class="mx-auto group" id="team">
		...
		<div>
			...
			<a href="/contact" class="btn-flashy group-hover:border-blue-600 group-hover:text-blue-600 dark:group-hover:border-white dark:group-hover:text-white px-4 py-2 rounded-full lg:text-2xl lg:px-8 lg:py-4">Design your new team</a>
		</div>
	</div>
	<div class="mx-auto group" id="strategy">
		...
		<div>
			...
			<a href="/contact" class="btn-flashy group-hover:border-blue-600 group-hover:text-blue-600 dark:group-hover:border-white dark:group-hover:text-white px-4 py-2 rounded-full lg:text-2xl lg:px-8 lg:py-4">Share your vision</a>
		</div>
	</div>
	<div class="mx-auto group" id="train">
		...
		<div>
			...
			<a href="/contact" class="btn-flashy group-hover:border-blue-600 group-hover:text-blue-600 dark:group-hover:border-white dark:group-hover:text-white px-4 py-2 rounded-full lg:text-2xl lg:px-8 lg:py-4">Book a session</a>
		</div>
	</div>
	<div class="mx-auto group" id="design">
		...
		<div>
			...
			<a href="/contact" class="btn-flashy group-hover:border-blue-600 group-hover:text-blue-600 dark:group-hover:border-white dark:group-hover:text-white px-4 py-2 rounded-full lg:text-2xl lg:px-8 lg:py-4">Start your redesign</a>
		</div>
	</div>
</div>
@endsection

...
@section('body-full')
		...
		<div class="flex flex-col container mx-auto mb-10 px-4">
			<div class="flex-1 max-w-[800px] mx-auto">
				...
				<p class="mt-0 mb-4">Working with Frendo means your investment goes directly into crafting your project. You never pay for layers of
					...
					efficient.</p>
					<p class="mt-0 mb-8">Invest in your future with Frendo and build a web system that can be expanded in the future to match your growth. <a class="text-green-700 hover:text-green-900 dark:text-green-300 dark:hover:text-green-600" href="/contact">Frendo is ready</a> to chart your course. </p>
			</div>
		</div>
		...
		<div class="w-full bg-green-200 dark:bg-cyan-950 flex px-4 text-center items-center justify-center flex-col text-white py-24">
			<h2 class="text-[4rem] lg:text-[6rem] xl:text-[12rem] xl:leading-[12.5rem] leading-[4.5rem] lg:leading-[6.5rem] text-emerald-950 dark:text-white">Let's surpass your {{ date('Y') }} web goals together.</h2>

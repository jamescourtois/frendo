...
@section('body')
    <div class="flex flex-col items-center justify-center text-center mb-2 lg:mb-4">
			...
			<p class="m-0 flex-1 mb-6">
				Check out each core service below. Whether you need a new website or a simple bug fix, you are in the right place. If you don't find what you need below, fret not. Frendo has the remedy to your web-related woes, all you have to do is <a href="/contact" class="text-green-700 hover:text-green-900 dark:text-green-300 dark:hover:text-green-600">reach out</a>.
			</p>
		</div>
@endsection
@section('body-full')
		<ul class="list-none grid md:grid-cols-4 lg:grid-cols-5 gap-2 text-gray-900 dark:text-gray-200 px-2">
			<li class="flex flex-col justify-start items-start md:col-span-2 lg:col-span-3 bg-green-200 dark:bg-green-950 p-10">
			...
			<li class="flex flex-col justify-start items-start md:col-span-2 lg:col-span-2 bg-teal-200 dark:bg-teal-950 p-10">
			...
			<li class="flex flex-col justify-start items-start md:col-span-2 lg:col-span-2 bg-emerald-200 dark:bg-emerald-950 p-10">
			...
			<li class="flex flex-col justify-start items-start md:col-span-2 lg:col-span-3  bg-cyan-200 dark:bg-cyan-950 p-10">
		...
		<div class="flex flex-col container mx-auto py-10 px-4">
			<div class="flex-1">
				...
				<p class="mt-0 mb-8">Build with Frendo and maintain full ownership of your code, content and data. When maintenance gets too heavy, <a class="text-green-700 hover:text-green-900 dark:text-green-300 dark:hover:text-green-600" href="/contact">Frendo is here</a> to do all the lifting for you. </p>
			</div>
		...
		<div class="w-full bg-green-200 dark:bg-emerald-950 flex px-4 text-center items-center justify-center flex-col text-white py-24">

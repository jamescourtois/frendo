...
@section('body-full')
		<ul class="list-none grid md:grid-cols-4 lg:grid-cols-12 gap-1 px-1 text-gray-950 dark:text-gray-200">
			...
			<li class="flex flex-col justify-start items-start md:col-span-2 lg:col-span-6 bg-green-300 dark:bg-green-950 p-10 lg:p-20">
			...
			<li class="flex flex-col justify-start items-start md:col-span-2 lg:col-span-6 bg-yellow-300 dark:bg-yellow-950 p-10 lg:p-20">
			...
			<li class="flex flex-col justify-start items-start md:col-span-2 lg:col-span-6  bg-cyan-200 dark:bg-cyan-950 p-10 lg:p-20">
		...
		<div class="w-full bg-green-200 dark:bg-cyan-950 flex px-4 text-center items-center justify-center flex-col text-white py-24">
			<h2 class="text-[4rem] lg:text-[6rem] xl:text-[12rem] xl:leading-[12.5rem] leading-[4.5rem] lg:leading-[6.5rem] text-emerald-950 dark:text-white">Let's crush your {{ date('Y') }} web goals together.</h2>
